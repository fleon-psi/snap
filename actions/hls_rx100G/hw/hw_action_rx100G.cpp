		...
		action_reg *act_reg)
{
	...
	process_frames(din_eth, eth_settings, eth_stats, dout_gmem, in_gain_pedestal_addr, out_frame_buffer_addr, out_frame_status_addr, d_hbm_p0, d_hbm_p1, d_hbm_p2, d_hbm_p3, d_hbm_p4, d_hbm_p5);
